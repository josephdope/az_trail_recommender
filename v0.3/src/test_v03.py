from hiking_data_v03 import DataGrabber, DataShaper, DatabaseExport
from trail_recommender_v03 import Trail_Recommender
import psycopg2
...
details = DataGrabber(url = None)
details.links_table = data
details.grab_reviews()

reviews = details.reviews_table
